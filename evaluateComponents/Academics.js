...
const Academics = ({userData, setUserData}) => {
    ...
    const {  study_level,
      bachelors_result, bachelors_dept, bachelors_institute, bachelors_pyear, faculty_name,
  ...
  const years = yearData.map((name) => (
          ...
          return (
            <>
               <div className="custom-form mt-4 mr-3 ml-1" >
                 ...
                 >
                  <option value="" disabled selected='selected'>SSC group</option>
             ...
             <div className="custom-form mt-4 mr-3 ml-1" >
                 ...
                 onChange={handleInput}
                 >
                   <option value="" disabled selected>SSC board</option>
                {boards}
                 ...
                 onChange={handleInput}
                 >
                    <option value="" disabled selected>SSC passing year</option>
                {years}
                </select>
                  ...
                  <div className="custom-form mt-4 mr-3 ml-1" >
                   <h6 className='ms-2'> Which faculty do you want to study in? *</h6>
                   <div className='select-wrapper'>
                   <Grid container>
            ...
            <>
             ...
             <div className="custom-form mt-4 mr-3 ml-1" >
              ...
              <div className="custom-form mt-4 mr-3 ml-1" >
                 ...
                 onChange={handleInput}
                 >
               <option value="" disabled selected='selected'>HSC group</option>
                <option value="Science">Science</option>
                <option value="Arts">Arts</option>
                <option value="Commerce">Commerce</option>
             ...
             <div className="custom-form mt-4 mr-3 ml-1" >
                 ...
                 onChange={handleInput}
                 >
                   <option value="" disabled selected>HSC board</option>
                {boards}
                 ...
                 onChange={handleInput}
                 >
                    <option value="" disabled selected>HSC passing year</option>
                {years}
                </select>
    ...
    return (
        <div>
            ...
            <Typography style={{padding:'20px 10px',color:'black',fontWeight:'bold'}} variant='h6' align='center'>Academics</Typography>   
            <div className="custom-form mt-4 mr-3 ml-1" >
